...
class AuthController:
    ...
    def login(self, user_id: str, password: str):
        ...
        data = {"userId": enc_user_id, "userPswdEncn": enc_password, "inpUserId": user_id}
    ...
    def _get_rsa_key(self):
        ...
        res = self.http_client.get("https://www.dhlottery.co.kr/login/selectRsaModulus.do", headers=headers)
